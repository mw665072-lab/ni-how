  ...
  return (
    <div className="h-screen flex flex-col md:pb-0 pb-8 w-full md:px-8 px-8" dir="rtl">
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-24">
        ...
        >
          <div className="flex flex-wrap-reverse justify-center gap-3 w-full items-center">
            {/* Yellow User Guide Button */}
            <Button
              onClick={() => setIsVideoModalOpen(true)}
              className="flex-1 min-w-[140px] md:flex-none md:w-52 bg-[#FFCB08] h-14 hover:bg-[#FFCB08] text-[#1F1F1F] py-4 rounded-2xl flex items-center justify-center gap-3 text-lg font-bold border-b-[4px] border-b-[#DEA407] shadow-sm hover:scale-[1.02] active:translate-y-[2px] active:border-b-0 transition-all"
            >
            ...
            <Button
              ...
              className="flex-1 min-w-[140px] md:flex-none md:w-52 bg-[#E5E5E5] h-14 hover:bg-[#E5E5E5] text-[#1F1F1F] py-4 rounded-2xl flex items-center justify-center gap-3 text-lg font-bold border-b-[4px] border-b-[#C4C4C4] disabled:opacity-50 disabled:border-none shadow-sm hover:scale-[1.02] active:translate-y-[2px] active:border-b-0 transition-all"
            >
            ...
            <Button
              ...
              className="w-full md:w-52 bg-[#35AB4E] h-14 hover:bg-[#35AB4E] text-white py-4 flex items-center justify-center gap-3 text-lg font-bold rounded-2xl border-b-[4px] border-b-[#298E3E] disabled:opacity-50 disabled:cursor-not-allowed disabled:border-none shadow-sm hover:scale-[1.02] active:translate-y-[2px] active:border-b-0 transition-all"
            >
