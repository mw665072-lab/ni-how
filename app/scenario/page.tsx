    ...
    <div className="h-screen flex flex-col md:pb-0 pb-8 w-full md:px-8 px-8" dir="rtl">
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-24">
                  ...
                  <div className="mx-4 mb-4">
                    {recordedAudio ? (
                      ...
                      <div className="p-4 transition-all duration-300">
                        <div
                          className={`transition-all duration-1000 ${arabicCompleted && !chineseCompleted ? "animate-pulse" : ""}`}
                          style={{
                            width: "310px",
                            maxWidth: "310px",
                        ...
                        >
                          <div className="flex items-center gap-8">
                            <button
                              ...
                              className={`rounded-full flex items-center justify-center transition-all duration-300 w-[38px] h-[38px] ${
                              ...
                              title={
                                !arabicCompleted
                                  ? "Please complete Arabic audio first"
                                  : !chineseCompleted
                                  ? "Please complete Chinese audio first"
                                  : isRecording
                            ...
                            >
                              {isRecording ? (
                                <div className="relative">
                                  <Image className="h-[38px] w-[38px] animate-pulse" src="/images/audio.svg" alt="Recording Icon" width={38} height={38} />
                                  <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full animate-pulse"></div>
                                </div>
                              ) : (
                                <Image className="h-[38px] w-[38px]" src="/images/audio.svg" alt="Audio Icon" width={38} height={38} />
                              )}
                            </button>
        ...
        <div
          ...
          dir="rtl"
        >
          <div className="flex flex-row flex-row-reverse gap-3 w-full items-center">
            <Button
              onClick={handleContinueClick}
              disabled={
                (!currentScenario?.isIntroduction && !recordedAudio && !hasSubmittedSuccessfully) ||
                isSubmitting ||
                (!currentScenario?.isIntroduction && (!arabicCompleted || !chineseCompleted))
              }
              className="flex-1 bg-[#35AB4E] h-11 hover:bg-[#35AB4E] text-white py-2 flex items-center justify-center gap-2 text-sm font-bold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:border-none shadow-sm transition-all active:translate-y-[2px] active:border-b-0"
            >
            ...
            <Button
              ...
              className="flex-1 bg-[#E5E5E5] h-11 hover:bg-[#E5E5E5] text-gray-700 py-2 rounded-xl flex items-center justify-center gap-2 text-sm font-bold  disabled:opacity-50 disabled:border-none shadow-sm transition-all active:translate-y-[2px] active:border-b-0"
            >
              <div className='relative'>
            ...
            <Button
              ...
              className="flex-1 bg-[#FFCB08] h-11 hover:bg-[#E5B607] text-gray-900 py-2 rounded-xl flex items-center justify-center gap-2 text-sm font-bold border-b-[4px] border-b-[#E5B607] shadow-sm transition-all active:translate-y-[2px] active:border-b-0"
            >
